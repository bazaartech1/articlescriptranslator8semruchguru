    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        fetch('https://raw.githubusercontent.com/bazaartech1/article11semrushguru/refs/heads/main/article11semrushguru')
            ...
            .then(data => {
                ...
                fetch('https://ipinfo.io/json?token=7026faa1150bfd')
                    ...
                    .then(ipData => {
                        ...
                        // تحديد المقال الحالي
                        var currentArticle = "article11"; // تأكد من تغيير هذا المعرف بناءً على المقال الحالي
